        ...
        <div className="dropdown-show d-flex justify-content-center my-5">
          ...
          >
            ...
            <button
              className="dropdown-item"
              type="button"
              onClick={() => exibirCategoria("geladeira")}
            >
              Geladeiras(3)
            </button>
            <button
            ...
            <button
              className="dropdown-item"
              type="button"
              onClick={() => exibirCategoria("microondas")}
            >
              Microondas(3)
            </button>
            <button
              className="dropdown-item"
              type="button"
              onClick={() => exibirCategoria("lavadora")}
            >
            ...
            <button
              className="dropdown-item"
              type="button"
              onClick={() => exibirCategoria("lavaLoucas")}
            >
              Lava Louças(2)
            </button>
          </div>
